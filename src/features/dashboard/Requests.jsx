    ...
    <Card>
                <div className="font-satoshi">
                  ...
                  <p className="mt-1 text-[12px] font-medium text-slate-500">
                    Review, approve, or reject employee request for leave and reimbursements.
                  </p>
                </div>
                      ...
                      >
                        <div className="flex min-w-0 flex-1 items-center gap-3">
                          <Avatar className="h-10 w-10 shrink-0">
                            <AvatarImage src={avatarImages[item.avatarKey]} alt={item.name} />
                            <AvatarFallback>
                        ...
                        <div className="text-sm font-normal text-slate-700">{item.date}</div>
                        <div className="flex flex-1 min-w-0 justify-end items-center gap-2">
                          <span className="text-sm font-normal text-slate-700">{item.note}</span>
                          <button type="button" aria-label="More actions" className="shrink-0 rounded p-1 text-slate-500 hover:bg-slate-100">
                    ...
                    {reimbursementRequests.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex shrink-0 gap-2">
                          <Button variant="secondary" className="rounded-lg bg-[#2684FF]/10 text-[#2684FF] hover:bg-[#2684FF]/20 border-0">
                            Reject
                          </Button>
                          <Button variant="primary" className="rounded-lg bg-[#2684FF] text-white hover:bg-blue-600">
                            Approve
                          </Button>
                        </div>
                      </div>
